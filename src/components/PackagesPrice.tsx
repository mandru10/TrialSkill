  ...
  return (
    <div className="mt-[100px]">
      <div className='flex items-center justify-center'>
            <span className='text-5xl md:text-6xl font-bold z-50'>Packages</span>
      ...
      {fictivePackages.map((packageItem, index) => (
        <div key={index} className='bg-white shadow-lg rounded-lg overflow-hidden'>
          ...
          />
          <div className='p-4'>
            <h2 className='text-2xl font-semibold text-gray-800'>{packageItem.title}</h2>
            <p className='text-gray-600 mt-2'>{packageItem.description}</p>
            <div className='mt-4'>
              <p className='text-3xl font-bold bg-black]'>${packageItem.price}</p>
