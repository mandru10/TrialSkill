...
// move into folder, create custom hook
function TestimonialsArticle() {
  const testimonials = [
    ...
    },
    {
      ...
      image:
        "https://img.freepik.com/premium-photo/young-caucasian-man-isolated-blue-background-who-feels-confident-crossing-arms-with-determination_1187-197159.jpg",
    },
  ];
  ...
  return (
    <div className="px-4 py-16">
      <div className="flex items-center justify-center">
        <span className="text-5xl md:text-6xl font-bold mb-[30px]">
          Testimonials
        </span>
          ...
          {testimonials.map((testimonials) => (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">{testimonials.position}</p>
